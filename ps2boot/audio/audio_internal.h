...
/*
 * Sinalizacao interna entre o sound thread (que detecta underrun real) e
 * ps2_audio_get_buffer_status (que reporta pro libretro). Setado em
 * ps2_audio_recover_backend_underrun, consumido (read-and-clear) na
 * proxima chamada de get_buffer_status. Volatile porque atravessa
 * threads.
 */
